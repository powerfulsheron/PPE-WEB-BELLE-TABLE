		...
		<div class="container">
			<div class="row">
				...
				<div class="apropos">
					...
					<br>
					<p>From the most classic to the most innovative, all your events can be imagined with Belletable, with perfectly maintained luxury equipment.</p>
					<br>
					<p>Belletable now offers a complete service with the rental, including Delivery, setting of tables, installation of various materials, table service as well as washing dishes and clothing.</p>
					<br>
					<p>At Belletable, we strive for the success of your event in the rules of French Luxury</p>
				</div>			
			</div>
		</div>		
	</div>
