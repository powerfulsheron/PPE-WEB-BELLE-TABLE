						...
						<tr>
							<td>
								<div class="inscription">
									...
									<input type="button" id="creercompte" value="Create Account" onclick="location.href='inscription-en.php';"/>
									<br><br>
								</div>
							</td>
							...
							<td>
								<div class="connexion">
									...
									<form  action="connexion-en.php" id="myform" method="GET" enctype="multipart/form-data">
										...
										<input type="submit" id="seconnecter" value="Login" onclick="document.forms[\'myform\'].submit();"/><br/><br/>
